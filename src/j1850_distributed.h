...
#define TIMEOUT_ACCEPT_DATA_US 100000
#define SPEED_I2C 3400000
...
class j1850_slave : public j1850
{
  ...
  public:
    void init(int, int, Print *pr_ = &Serial, int address = ADDRESS_I2C, long speed = SPEED_I2C);
...
{
  public:
    void init(int _address = ADDRESS_I2C, long speed = SPEED_I2C, Print *pr_ = &Serial);
